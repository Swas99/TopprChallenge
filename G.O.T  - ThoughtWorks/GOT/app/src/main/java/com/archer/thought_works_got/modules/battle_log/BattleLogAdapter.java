 ...
 */
public class BattleLogAdapter
        extends RecyclerView.Adapter<BattleLogAdapter.MyViewHolder>
        implements Filterable
{
    private BattleLog mContext;
    ...
    public BattleLogAdapter(List<KingsDO> _kingData, BattleLog _context)
    {
        mContext = _context;
        itemList = _kingData;
